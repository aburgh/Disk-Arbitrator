...
- (NSToolbarItem *)toolbar:(NSToolbar *)toolbar itemForItemIdentifier:(NSString *)itemIdentifier willBeInsertedIntoToolbar:(BOOL)flag
{
	...
	if ([itemIdentifier isEqual:ToolbarItemInfoIdentifier])
	{
		// Info/Inspect
	...
	else if ([itemIdentifier isEqual:ToolbarItemEjectIdentifier])
	{
		// Eject
	...
	else if ([itemIdentifier isEqual:ToolbarItemMountIdentifier])
	{
		// Mount
	...
	else if ([itemIdentifier isEqual:ToolbarItemAttachDiskImageIdentifier])
	{
		// Attach Disk Image
